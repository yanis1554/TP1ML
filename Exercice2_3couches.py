...
mlp=  MLPRegressor(hidden_layer_sizes=(10,10,10),activation='relu',solver='adam',alpha=0.01,batch_size='auto',learning_rate='adaptive', learning_rate_init=0.01,max_iter=1000, tol=10**(-4), verbose=True, warm_start=False, early_stopping=True, validation_fraction=0.1, n_iter_no_change=50)  
...
plt.title("y_test vs y_test_predict pour un réseau de de 3 fois 10 neurones")
plt.show()
