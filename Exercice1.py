...
mlp=  MLPRegressor(hidden_layer_sizes=(5),activation='logistic',solver='adam',alpha=0.01,batch_size='auto',learning_rate='adaptive', learning_rate_init=0.01,max_iter=1000, tol=10**(-4), verbose=True, warm_start=False, early_stopping=True, validation_fraction=0.1, n_iter_no_change=50)  
...
mlp=  MLPRegressor(hidden_layer_sizes=(10),activation='logistic',solver='adam',alpha=0.01,batch_size='auto',learning_rate='adaptive', learning_rate_init=0.01,max_iter=1000, tol=10**(-4), verbose=True, warm_start=False, early_stopping=True, validation_fraction=0.1, n_iter_no_change=50)  
...
mlp=  MLPRegressor(hidden_layer_sizes=(20),activation='logistic',
                   solver='adam',alpha=0.01,batch_size='auto',
                   learning_rate='adaptive', learning_rate_init=0.01,
                   max_iter=1000, tol=10**(-4), verbose=True, 
...
mlp=  MLPRegressor(hidden_layer_sizes=(50),activation='logistic',solver='adam',alpha=0.01,batch_size='auto',learning_rate='adaptive', learning_rate_init=0.01,max_iter=1000, tol=10**(-4), verbose=True, warm_start=False, early_stopping=True, validation_fraction=0.1, n_iter_no_change=50)  
...
mlp=  MLPRegressor(hidden_layer_sizes=(70),activation='logistic',solver='adam',alpha=0.01,batch_size='auto',learning_rate='adaptive', learning_rate_init=0.01,max_iter=1000, tol=10**(-4), verbose=True, warm_start=False, early_stopping=True, validation_fraction=0.1, n_iter_no_change=50)  
...
mlp=  MLPRegressor(hidden_layer_sizes=(100),activation='logistic',solver='adam',alpha=0.01,batch_size='auto',learning_rate='adaptive', learning_rate_init=0.01,max_iter=1000, tol=10**(-4), verbose=True, warm_start=False, early_stopping=True, validation_fraction=0.1, n_iter_no_change=50)  
...
plt.plot(hidden,L_score_train,'r')
plt.plot(hidden,L_score_test,'b')
...
# Meme travail avec la fonction d'activation relu
hidden_r = [5,10,20,50,70,100]
L_score_train_r = []
L_score_test_r = []
Time_r = []
...
mlp.fit(x_train, y_train) 
delta1 = time.time()-start
Time_r.append(delta1)
# prediction des valeurs de test
y_test_predict = mlp.predict(x_test)
# score
score_train = mlp.score(x_train,y_train)
score_test = mlp.score(x_test,y_test)
L_score_train_r.append(score_train)
L_score_test_r.append(score_test)

# comparaison reel/predict
plt.plot(y_test,"bo")
plt.plot(y_test_predict,"rx")
plt.xlabel("itération")
plt.title("y_test vs y_test_predict")
plt.show()
...
# Comparaison hidden vs train_score and test_score
plt.plot(hidden,L_score_train_r,'r')
plt.plot(hidden,L_score_test_r,'b')
plt.xlabel("nombre de neurones")
plt.legend()
plt.title('train_score and test_score selon le nombre de neurones du réseau')
plt.show()
